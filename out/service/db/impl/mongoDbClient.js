    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.dbClient || !this.dbClient.isConnected()) {
                ...
                this.dbClient = new mongodb_1.MongoClient(commonConstants_1.CommonConstants.DBCONFIGURATIONURL, {
                    auth: {
                        password: commonConstants_1.CommonConstants.DBCONFIGURATIONPASSWORD,
                        user: commonConstants_1.CommonConstants.DBCONFIGURATIONUSERNAME,
                    },
    ...
    getConnection() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new serviceException_1.ServiceException([error], errorCodes_1.ErrorCodes.ERR_SERVICE_DB_CONNECTION, 500);
            }
        });
    }
};
...
], MongoDbClient.prototype, "iLoggerService", void 0);
