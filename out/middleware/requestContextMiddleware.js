...
let RequestContextMiddleware = class RequestContextMiddleware {
    constructor(iLoggerService, requestContext) {
        this.iLoggerService = iLoggerService;
        this.requestContext = requestContext;
        this.invoke = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
...
RequestContextMiddleware = __decorate([
    ...
    __param(1, (0, inversify_1.inject)(baseIdentifiers_1.BaseIdentifiers.RequestContext)),
    __metadata("design:paramtypes", [Object, requestContext_1.RequestContext])
